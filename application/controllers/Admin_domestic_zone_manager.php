...
class Admin_domestic_zone_manager extends CI_Controller {
	...
	{  	   
		...
		if(!empty($alldata))
		{
			...
			$this->basic_operation_m->addLog($this->session->userdata("userId"),'master','Add Domastic Zone Master', $alldata);
	...
	{  
		if(!empty($id))
		{
			...
			$this->basic_operation_m->addLog($this->session->userdata("userId"),'master','Delete Domastic Zone Master', $id);
	...
	{  
		...
		if(!empty($alldata))
		{
			...
			$this->basic_operation_m->addLog($this->session->userdata("userId"),'master','Update Domastic Zone Master', $alldata);
