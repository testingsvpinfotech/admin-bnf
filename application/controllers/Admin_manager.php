...
class Admin_manager extends CI_Controller 
{
	...
	public function view_dashboard() 
	{
        ...
        if($this->session->userdata("userType") == '6')
		{
			...
			$data['customers'] = $this->db->query("select count(customer_id) as cust from tbl_customers where sales_person_id = '$user_id' and sales_person_id != '0'")->row();
			$this->load->view('admin/view_sales_dashboard', $data);
		}else{
