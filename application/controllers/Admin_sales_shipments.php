...
class Admin_sales_shipments extends CI_Controller {
    ...
    public function branch_report($offset=0,$searching='')
	{
		...
		if(!empty($all_data))
		{
			...
			{   
				...
				WHERE $whr_d limit 100")->result_array();
		...
		$config['base_url'] 			= 'admin/sales-customer-shipments/';
		...
		$this->load->view('admin/sales_shipments/view_sales_shipments',$data);
	}
	...
	{    
		...
		$date=date('d-m-Y');
		$filename = "Sales_Shipments_report_".$date.".csv";
