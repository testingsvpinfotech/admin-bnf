...
class Customer_model extends CI_Model
{
	...
	{
		$this->db->select('tbl_customers.*,aw.customer_name as parent_name,state.state,city.city,tbl_users.username as sale_person_name,tbl_users.branch_id ,tbl_branch.branch_name as sale_person_branch ');
