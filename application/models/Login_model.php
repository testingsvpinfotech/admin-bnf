...
class Login_model extends CI_Model {
	...
	public function checkAdminLoginsales($username,$password)
	{ 
	...
	{ 
		...
		if($query->num_rows() == 1)
		{
			...
			$loginInfo = array("userId"=>$userId,"method"=>'Login',"updatedData" =>json_encode($this->session->userdata()), "machineIp"=>$_SERVER['REMOTE_ADDR'], "userAgent"=>getBrowserAgent(), "agentString"=>$this->agent->agent_string());
			$this->db->insert('tbl_loghistory', $loginInfo);
