                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" id="search_data" name="awb_no" placeholder="Enter AWB No" required style="float: right;">
                                        ...
                                        <a href="<?= base_url('admin/single-delivery-update'); ?>" style="color:blue; float: right; margin-right:9px;">Reset</a>
                                                ...
                                                <?php $count = 1; if ($result) { //print_r($result);
                                                    foreach ($result as $value) {
                                                        ...
                                                        <td><input type="datetime-local" class="form-control"  value="<?php echo Date('Y-m-d\TH:i',time()) ?>" required name="datetime"  id="mastermenifest_back" min="<?= date('Y-m-d H:i', strtotime($drs_date)); ?>" max="<?= date('Y-m-d').'T'.date('H:i'); ?>"></td>
                                                            ...
                                                            <td><textarea name="comment" class="form-control" required placeholder="Comment"></textarea></td>
                                                            <td><textarea name="remark" class="form-control" required placeholder="Remark"></textarea></td>
