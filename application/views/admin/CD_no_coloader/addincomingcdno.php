                  ...
                  <div class="col-12  align-self-center">
                      ...
                      <div class="card">
                          <div class="card-header justify-content-between align-items-center">
                              <h4 class="card-title">Add Incoming CD No</h4>  
                          </div>
                          <div class="card-body">
                              
						   <div class="row">                                           
                            <div class="col-12">
								 <form role="form" action="admin/incoming-cdno-inscan" method="post">
        <div class="box-body">
				<div class="form-group row">
						<label class="col-sm-1 col-form-label">CD NO:</label>
						<div class="col-sm-2">
							...
							<?php 
								if(!empty($menifiest))
								{
									...
									{ 
										...
										{			   			   
										?>
											<option value="<?php echo $row->manifiest_id;?>" <?php echo ($manifiest_id == $row->manifiest_id)?'selected':'';?> ><?php echo $row->cd_no;?> --<?php echo $row->date_added;?></option>
										<?php 
										}
									}
								}
