               ...
               <div class="col-12 col-sm-12 mt-3">
                 <div class="card">
                   <div class="card-header justify-content-between align-items-center">
                     <h4 class="card-title">Admin Edit Franchise Shipments</h4>
                   </div>
                   <div class="card-body">
                     <div class="row">
                       <div class="col-12">
                         <form role="form" action="<?php echo base_url(); ?>admin/franchise-edit-view-list" method="post" autocomplete="off">
                           <div class="form-row">
                             <div class="col-md-2">
                             ...
                             <div class="col-md-2" style="display: none;">
                              ...
                              <div class="col-sm-2">
                               ...
                               <a href="<?= base_url('admin/franchise-edit-view-list');?>" class="btn btn-info">Reset</a>
                             </div>
                           </div>
                         </form>
                       </div>
                                     ...
                                     <?php
                                      ...
                                      ?>
                                           <tr>
                                             ...
                                             <a href="<?= base_url('admin/franchise-edit-view-shipment/'.$value_d['booking_id']); ?>">  <i class="ion-edit" style="color:var(--primarycolor)"></i></a></td>
                                           </tr>
                                       <?php
                                          }
                                        }
