     					...
     					<div class="col-12 col-sm-12 mt-3">
     						<div class="card">
     							<div class="card-header justify-content-between align-items-center">
     								<h4 class="card-title">Upcoming Master Menifest</h4>
     							</div>
     							<div class="card-body">
     								...
     								<div class="row">
     									<div class="col-12">
     										<!-- <form role="form" action="<?= base_url(); ?>admin/view-genrated-gatepass" method="post" enctype="multipart/form-data">
     											<div class="form-group row">
     												<label class="col-sm-1 col-form-label">Gatepass No</label>
     												<div class="col-sm-2">
     													...
     													<tbody>
															<?php $count = 1; if($result){  foreach ($result as $key=>$value) {  ?>
																<tr>
																	...
																	<td><?php echo $value->total_no_bag;?></td>
																	<td><?php echo $value->origin;?></td>
																	<td><?php echo $value->destination;?></td>
																	<td><?php echo $value->genrated_by;?></td>
																</tr>
															<?php }} ?>
     													</tbody>
