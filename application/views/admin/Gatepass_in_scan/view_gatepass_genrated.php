     					...
     					<div class="col-12 col-sm-12 mt-3">
     						<div class="card">
     							<div class="card-header justify-content-between align-items-center">
     								<h4 class="card-title">Master Menifest Genrated</h4>
     							</div>
     							<div class="card-body">
     								...
     								<div class="row">
     									<div class="col-12">
     										<form role="form" action="<?= base_url(); ?>admin/view-genrated-in-scan" method="post" enctype="multipart/form-data">
     											<div class="form-group row">
     												<label class="col-sm-2 col-form-label">Master Menifest No</label>
     												<div class="col-sm-2">
     													<input type="text" name="gate_no" id="awb" class="form-control" />
     												</div>
     												<div class="col-sm-2">
     												...
     												<table class="table table-bordered table-striped">
     													<thead>
															 ...
															 <th></th>
     															...
     															<th>Line hual status</th>
     															<th>Line hual Route</th>
     															<th>Line hual Destination Branch</th>
     														</tr>
     													</thead>
     													<tbody>
															<?php  $count = 1; if($result){  foreach ($result as $key=>$value) { ?>
																<tr>
																<td><?= $count++; ?></td>
																	<td><?php echo date_format(date_create($value->date_added),'d-m-Y');?> <input type="hidden" id="custId" name="manifiest_id" value="<?php echo $value->manifiest_id;?>"></td>
																	<td><?php echo $value->bag_no;?></td>
																	<td><?php echo $value->gatepass_no;?></td>
																	<td><?php echo $value->manifiest_id;?></td>
																	<td><?php echo $value->username;?></td>
																	<td><?php echo $value->lorry_no;?></td>
																	<td><?php echo $value->driver_name;?></td>
																	<td><?php echo $value->source_branch;?></td>
																	<td><?php echo $value->destination_branch;?></td>
																	<td><?php if($value->line_access=='1'){echo 'yes';}else{echo 'No';} ?></td>
																	<td><?php if($value->line_access=='1'){ 
																	   echo $this->db->query("select * from tbl_line_hual_master where route_id = '$value->line_hual_id'")->row('route_name');																		
																	}else{echo '';} ?></td>
																	<td><?php if($value->line_access=='1'){ 
																		echo $this->db->query("select * from tbl_branch where branch_id ='$value->m_manifest_destination'")->row('branch_name');
																	}else{echo '';} ?></td>
																</tr>
															<?php }} ?>
     													</tbody>
