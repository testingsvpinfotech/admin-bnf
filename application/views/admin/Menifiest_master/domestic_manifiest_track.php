    ...
    <div class="col-12  align-self-center">
        ...
        <div class="card">
            <div class="card-header justify-content-between align-items-center">
                <h4 class="card-title">Domestic Manifest Tracking</h4>  
							<span style="float: right;">
							 <form method='post' action="admin/tracking-domestic-menifiest/post">
										<input type="text" name="manifiest_id" placeholder="Manifest Number" style="height: 31px;"/>
										...
										<a href="admin/download-domestic-tracking-menifiest/<?php echo $manifiest[0]['manifiest_id']; ?>"  class="btn btn-info">Download </a>	
										<?php } ?>
                          ...
                          <div class="card-body" style="font-size: 14px;"> 
                            <div class="row" >    
                                <div class="col-12"> 
                                      <center><strong style="font-size: 20px;" >Manifest</strong></center>
                                 </div>
                            </div>
                            <div class="row">                                           
                              <div class="col-12">
                              ...
                              <div class="table-responsive">
                                  <table style="width:100%;border: 1px solid;">
								   ...
								   <th>DATE &nbsp;:&nbsp;<?php if(!empty($manifiest)){ echo date("d-m-Y",strtotime($manifiest[0]['date_added']));} ?><br>                       
									MANIFEST NO &nbsp;:&nbsp; <?php if(!empty($manifiest)){ echo $manifiest[0]['manifiest_id'];} ?><br> Vendor Name &nbsp;:&nbsp; <?php 
									if(!empty($manifiest))
									{ 
								$resActs=$this->db->query("select * from tbl_vendor where tv_id='".$manifiest[0]['vendor_id']."'");

			 if($resActs->num_rows()>0)
			 {
				$vendor_info=$resActs->row();	            
				echo $vendor_info->vendor_name; 
			 }} ?></th>                                               
				<th>COLOADER &nbsp;:&nbsp; <?php if(!empty($manifiest)){echo $manifiest[0]['coloader'];} ?><br>Destination Branch &nbsp;:&nbsp; <?php if(!empty($manifiest)){echo $manifiest[0]['destination_branch'];} ?> <br> Vehicle No &nbsp;:&nbsp;<?php if(!empty($manifiest)){echo $manifiest[0]['lorry_no'];} ?>
							   </th>
				<th>TOTAL NO OF SHIPMENT &nbsp;:&nbsp;<?php if(!empty($manifiest)){echo $total_pcs;} ?><br>                       
								...
								Driver Name &nbsp;:&nbsp;<?php if(!empty($manifiest)){echo $manifiest[0]['driver_name'];} ?>
							  
              </th>
              <th>Menifisted By &nbsp;:&nbsp; <?= $manifiest[0]['username']; ?><br>
							  Supervisor &nbsp;:&nbsp; <?= $manifiest[0]['supervisor']; ?><br></th>
                                  ...
                                  <table style="width:100%;border:1px solid;">
                                       <thead>
                                          <tr>  
											    ...
											    <th style="border:1px solid;text-align: center!important;">BAG No.</th>
                                              ...
                                              $j=1;
                                                foreach ($manifiest as  $value) 
												{
                                                  ...
                                                  <tr>           
                                                    ...
                                                    <td align="center" style="border:1px solid;"><?php echo $value['bag_no'];?></td>
													<td align="center" style="border:1px solid;text-transform: uppercase;"><?php echo$value['forwarder_mode'];?></td>
