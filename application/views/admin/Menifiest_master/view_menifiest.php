                    ...
                    <div class="col-12 col-sm-12 mt-3">
                        <div class="card">
                            <div class="card-header justify-content-between align-items-center">
                                ...
                                <span style="float: right;"><a href="admin/menifiest-add" class="btn btn-primary">Add
                                        Menifiest</a></span>
                            </div>
                                            ...
                                            if (!empty($allpod)) {
                                                ...
                                                foreach ($allpod as $ct) { ?>
                                                    <tr>
                                                        ...
                                                        <td><a
                                                                href="admin/tracking-domestic-menifiest/<?php echo $ct->manifiest_id; ?>">
                                                                <?php echo $ct->manifiest_id; ?>
                                                            </a></td>
                                                        <td>
                                                            <?php echo $ct->source_branch; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $ct->destination_branch; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $ct->forwarder_mode; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $ct->coloader; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $ct->coloder_contact; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $ct->cd_no; ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <?php if ($ct->gatepass == '0') { ?>
                                                                <a href="admin/edit-menifiest/<?php echo $ct->id; ?>"><i
