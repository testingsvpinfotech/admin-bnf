                    ...
                    <div class="col-12 col-sm-12 mt-3">
                        <div class="card">
                            <div class="card-header justify-content-between align-items-center">
                                <h4 class="card-title">Incoming Franchise Bag</h4>
                                <span style="float: right;"><a href="admin/add-franchise-incoming-bag"
                                        class="fa fa-plus btn btn-primary">Add Franchise Incoming Bag</a></span>
                            </div>
                                            ...
                                            if (!empty($allinword)) {
                                                ...
                                                foreach ($allinword as $value) {
                                                    ...
                                                    if ($total == 0) {
                                                        ...
                                                        <td><a
                                                                href="<?= base_url('admin/franchise-domestic-bag/' . $value['bag_id']); ?>">
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php } ?>
                                                            <?php if ($value['total_coming'] != '0') {
                                                                if ($value['total_pcs'] > $value['total_coming']) { ?>
                                                                    <a
                                                                        href="admin/add-franchise-incoming-bag/<?php echo $value['bag_no']; ?>"><i
