   ...
   // include('admin_shared/admin_sidebar.php'); ?>
        ...
        <div class="box-body">
			...
			<form role="form" action="admin/add-incoming-bag" method="post">
				...
				<div class="col-sm-2">
								  <input type="datetime-local" readonly class="form-control" name="datetime"  required  value="<?php echo Date('Y-m-d\TH:i',time()) ?>" id="mastermenifest_back" min="<?= date('Y-m-d', strtotime("-1 days")).'T'.date('H:i'); ?>" max="<?= date('Y-m-d').'T'.date('H:i'); ?>">
								</div>
					...
					<tr>
					  <td><?=$value->pod_no?>
					  <input type="hidden" name="pod_no[]"  value="<?php echo $value->pod_no; ?>">
					</td>
