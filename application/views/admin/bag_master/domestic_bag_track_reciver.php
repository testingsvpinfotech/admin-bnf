                                              ...
                                              $j=1;
                                                foreach ($manifiest as  $value) 
												{
                                                  ...
                                                  <tr>           
                                                    ...
                                                    <td align="center" style="border:1px solid;"> <a href="<?= base_url('admin/domestic_printpod/'.$value['booking_id']) ?>" target="_blank" style="color:#007bff;"><?php echo $value['pod_no'];?></a> </td>
