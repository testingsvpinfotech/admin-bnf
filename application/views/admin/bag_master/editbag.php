...
<style>
						   ...
						   <div class="row">                                           
                            <div class="col-12">
								...
								<div class="form-group row">
									...
									<div class="col-sm-2">
										<input type="text" class="form-control" name="bag_id" id="col-sm-1 col-form-label" placeholder="Enter Id" readonly value="<?php echo $Bag_info->bag_id; ?>" >
									...
									<div class="col-sm-2">
										<input type="date" readonly class="form-control" name="datetime" id="col-sm-1 col-form-label"  value="<?php echo $Bag_info->date_added; ?>">
									</div>
  ...
  <?php 
				  if (!empty ($pod))
				  {
					...
					{
						$resAct			=	$this->db->query("select city from city where id='$value->reciever_city'")->row_array();
						$resActt			=	$this->db->query("select city from city where id='$value->sender_city'")->row_array();
						$city_reciever	= 	$resAct['city'];
						$city_sender	= 	$resActt['city'];
			...
			else
			{
                ...
                <tr>
						  ...
						  <input type='hidden' readonly name='branch_name' id='branch_name'  class='form-control' value="<?php echo $value->menifiest_branches; ?>"></td>
						  <!-- <input type='hidden' readonly name='branch_name' id='branch_name'  class='form-control' value="<?php echo $value->destination_branch; ?>"></td> -->
