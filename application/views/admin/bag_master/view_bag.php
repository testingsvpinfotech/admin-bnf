                  ...
                  <div class="col-12  align-self-center">
                      ...
                      <div class="card">
                          <div class="card-header justify-content-between align-items-center">
                              <h4 class="card-title">Domestic Bag</h4>  
                <span style="float: right;"><a href="admin/bag-add" class="btn btn-primary">Add Bag</a></span>							  
                          </div>
					...
					{  ?>
                      <tr>
                        <td><?php echo $cnt;?></td>
                        <td><a href="admin/tracking-domestic-bag/<?php echo $ct->bag_id;?>"><?php echo $ct->bag_id;?></a></td>
                        ...
                        <td><?php echo $ct->bkdate_reason;?></td>  
                        <td><a href="admin/edit-bag/<?php echo $ct->id;?>" ><i class="ion-edit" style="color:var(--primarycolor)"></i></a></td>
                    </tr>
                  <?php 
				  $cnt++;
				  } 
