    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col-12">
                ...
                $cust_name = !empty($customer->customer_name)?$customer->customer_name:$customer->consigner_name;

                $cust_address = !empty($cust_details1->address)?$cust_details1->address:$customer->consigner_address;
                $cust_gstno = $cust_details1->gstno;
                $state_code  =  substr($cust_gstno,0,2);
                $state_code  =  !(empty($state_code))?$state_code:'27';
                $sac_code = !empty($cust_details1->sac_code)?$cust_details1->sac_code:'NA';
                $cus_code = !empty($cust_details1->cid)?$cust_details1->cid:'NA';
                $credit_days = !empty($cust_details1->credit_days)?$cust_details1->credit_days:'NA';
               ...
               $topay = strtoupper($customer->payment_type);
               ...
               // print_r($get_mod['mode_dispatch']);
                ...
                <table class="table table-bordered" cellpadding="5">
                    ...
                    <tr>
                        <td width="100%" colspan="4" style="background: #ddd; font-weight: bold; text-align: center;padding: 10px"><span style="font-size:25px;">TAX INVOICE</span></td>
                    </tr>
                    <tr>
                        <td width="25%" rowspan="5"><b>Customer Name & Address </b> :<br/><br/><b><?= $cust_name; ?></b><br /><b> Address : </b><?= $cust_address; ?><br />
                        <b>GSTIN : <?= $cust_gstno; ?></b><br />
                        </td>

                        <td width="30%" style=""><b>Customer A/C. :</b> <?php echo $cus_code ;?> </td>
                        
                        <td width="25%" style=""><b>Invoice No. : </b><?= $invoiceNumebr; ?></td>
                    ...
                    <tr>
                        <td width="20%" style=""><b>Invoice Date : </b><?php if(!empty($invoiceDate)){ echo date('d-m-Y', strtotime($invoiceDate));} ?></td>
                    ...
                    <tr>
                        ...
                        <?php   if($topay =='TOPAY'){ $due_date =  $allpoddata[0]['delivery_date'];}else{$due_date = date('d-m-y' , strtotime( $invoiceDate . "+".$credit_days." days"));}?>

                        <td width="20%" style=""> <b>Due Date :</b> <?= $due_date;?></td>
                    ...
                    <tr>
                        ...
                        <td width="70%" colspan="2" class="text-center" style="padding: 10px;background-color: #ddd; font-size:20px;"><b>Chargeable of Freight</b></td>
                    </tr>
                    <?php $total_pkg = 0; 
                                $total_pcs = 0;
                       ...
                       <tr>
                         <td width="30%" colspan="2" rowspan="7" style="padding:30px;">
                    ...
                    $fuel_subcharges = array_sum($fuel); ?>
                           ...
                           <tr>
                            ...
                            <tr>
                              <td width="70%" colspan="2"> <b>Total Freight Amount : </b><span style="float: right;"><?= number_format($total_freight, 2); ?></span></td>
                            </tr>
                            <tr>
                              <td width="70%" colspan="2"> <b> Fuel Surcharge: </b><span style="float: right;"><?= number_format($fuel_subcharges, 2); ?></span></td>
                            </tr>
                            <tr>
                            <td width="70%" colspan="2">  <b>Total Other Charges: </b> <span style="float: right;"><?= number_format($total_other_charges, 2); ?></span></td>
                    ...
                    $total_taxable_amount123 = $total_taxable_amount1;
                    ?>
                    <?php $whr_c = array('customer_id' => $customer->customer_id);
                    $cust_details = $this->basic_operation_m->get_table_row('courier_fuel', $whr_c); ?>
                    <tr>
                        <td width="70%" colspan="2"><b>Sub Total <span style="float: right;"><?= number_format($total_taxable_amount1, 2); ?></span></b></td>
                    </tr>
                    <tr>
                        <td width="70%" colspan="2"><b>Taxable Amount <span style="float: right;"><?= number_format($total_taxable_amount123, 2); ?></span></b></td>
                    </tr>
                    <?php
                    ...
                    $gst  = $total_taxable_amount1;

                    $tototal_gst =  $customer->cgst_amount + $customer->sgst_amount  + $customer->igst_amount;
                    $tototal_amount = $gst + $customer->cgst_amount + $customer->sgst_amount  + $customer->igst_amount;
                    ...
                    <tr>
                        ...
                        <b> IGST TAX - <?=  $igst_per;?>%  </b><span style="float: right;"><?= number_format($customer->igst_amount, 2); ?></span><br />
                        <b>  CGST TAX - <?=  $cgst_per;?>%  </b><span style="float: right;"><?= number_format($customer->cgst_amount, 2); ?></span><br />
                        <b>   SGST TAX - <?=  $sgst_per;?>%  </b><span style="float: right;"><?= number_format($customer->sgst_amount, 2); ?></span>
                        </td>
                    </tr>
                    <tr>
                ...
                <table class="table table-bordered  table-th-font">
                    <thead>
                        <tr>
                            <td colspan="4" style="font-size:18px; font-weight:bold;"><?= $invoiceNumebr; ?></td>
                        ...
                        if (!empty($allpoddata)) {
                            foreach ($allpoddata as $key => $value) {
                                ...
                                $whr_c3 =array(
                                    ...
                                    // 'state_id'=>$reciever_state,
                                    //'city_id'=>$recieverCity
                                );
                                $current_date1 = date('Y-m-d', strtotime($current_date));
                                // $cust_details3 = $this->basic_operation_m->get_table_result('tbl_domestic_rate_master', $whr_c3);
                            ...
                            //    print_r($cust_details3)

                                // if(count($cust_details3) == 1){
                                //     $whr_c3['state_id'] = $reciever_state;
                                //     $whr_c3['city_id'] = $recieverCity;
                                //     $cust_details3 = $this->basic_operation_m->get_table_row('tbl_domestic_rate_master', $whr_c3);
                                //     $rate1 = $cust_details3->rate;
                                // }else{
                                //     $rate1 = $cust_details3[0]->rate;
                                // }

                                // if (empty($cust_details3)) {
                                //     unset($whr_c3['city_id']);
                                //     $whr_c3['state_id'] = $reciever_state;
                                //     $cust_details3 = $this->basic_operation_m->get_table_row('tbl_domestic_rate_master', $whr_c3);
                                //     if (empty($cust_details3)) {
                                //         unset($whr_c3['state_id']);;
                                //         $cust_details3 = $this->basic_operation_m->get_table_row('tbl_domestic_rate_master', $whr_c3);
                                //     }
                                // }
                                // if(!empty($rate)){ $rate1 = $rate; }
                             
                             
                             
                             
                               // $get_sender_customer_rate = $this->db->query("select rate from  tbl_domestic_rate_master where to_zone_id = '".$cust_details3['receiver_zone_id']."' AND customer_id = '".$cust_details3['customer_id']."'AND mode_id = '".$cust_details3['mode_dispatch']."'")->row_array();
                              ?> 
                                ...
                                <tr>
                                    ...
                                    <td class="text-right"><?= $subtotal12; ?></td>
                                </tr>
                    </tbody>
            <?php $cnt++;
                            }
                ...
                <table class="table table-bordered">
                    <tr>
                        <td colspan="10"></td>
                        <td width="30%">
                            <b>Total Freight Amount : </b><span style="float: right;"><?= number_format($total_freight, 2); ?></span><br />
                            <!-- <b>Fuel Surcharge: </b><span style="float: right;"><?= number_format($fuel_subcharges, 2); ?></span><br /> -->
                            <b>Taxable Amount </b><span style="float: right;"><?= number_format($total_taxable_amount123, 2); ?></span><br />
                            <b>IGST <?= $igst_per;?>% </b><span style="float: right;"><?= number_format($customer->igst_amount, 2); ?></span><br />
                            <b>CGST <?= $cgst_per;?>% </b><span style="float: right;"><?= number_format($customer->cgst_amount, 2); ?></span><br />
                            <b>SGST <?= $sgst_per;?>% </b><span style="float: right;"><?= number_format($customer->sgst_amount, 2); ?></span><br />
                            <!-- <b>Round Off </b><span style="float: right;">0</span><br /> -->
                            <b>Total Amount </b><span style="float: right;"><?= number_format($tototal_amount, 2); ?></span>
