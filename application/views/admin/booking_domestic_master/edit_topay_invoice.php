                               ...
                               <form role="form" id="billing-form" name="billing-form" action="<?php echo base_url(); ?>admin/edit-domestic-invoice/<?php echo $id; ?>" method="post">                                          
                                  <div class="row">
                                    <div class="form-group row col-6">
                                      <label class="col-3 mb-2">Consignee Name</label>
                                      <div class="col-6 mb-2">
                                        <input type="text" name="consignee_name" value="<?php echo $customer->consigner_name ?>" class="form-control" placeholder="Consignee Name"/>
                                      </div>
                                      ...
                                      <div class="col-6 mb-2">
                                        <input type="text" name="gstno" value="<?php echo $customer->consigner_gstno; ?>" class="form-control"/>
                                      </div>
                                   ...
                                   <table class="table table-bordered">                                  
                                      ...
                                      <?php
                                          ...
                                          foreach ($allpoddata as $value) {
                                             ...
                                             // print_r($city);
                                             $whr2 = array('id'=>$city->reciever_city);
