                                            ...
                                            <div class="card-body table-responsive">
                                                <table class="table">
                                                    <tbody>
                                                        <tr>
                                                            <td >
                                                                <?php $branch = $this->db->get_where('tbl_branch',['branch_id' => $customer->branch_id])->row(); ?>
                                   ...
                                   <div class="col-12 col-md-12">
                                            ...
                                            <div class="card-body table-responsive remove-bottom-border">
                                                <table class="viewInoviceHeader">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td><address>To,<br>
                                                                    <b style="font-size:15px!important;"><?php echo $booking->sender_name; ?></b><br> <?php echo $booking->sender_address; ?><br><b> Gst No : </b> <?php echo $booking->sender_gstno; ?><br>
                                                                    <b>PLACE OF SUPPLY : </b><?php	$whr_u =array('id'=>$booking->sender_state);
                                                        $state_details = $this->basic_operation_m->get_table_row('state', $whr_u);
                                                        // echo "<pre>";  print_r($cust_details); die;
																	echo $state_details->state; ?>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <b>State Code : </b><?php echo substr($state_details->statecode, 0, 2); ?></address></td>
                                                            <td><address>
                                                                    <b>Invoice No:</b>  <?php
                                    ...
                                    { 
                                                        ...
                                                        ?>
                                                            ...
                                                            <td class="text-center"><?= $value['delivery_charges']; ?></td>
                                                            ...
                                                            <!--  <b> A/C NAME :</b> <?php echo $company_details->account_name; ?><br>
                                                             <b>BRANCH :</b>  <?php echo $company_details->bank_name; ?>,<?php echo $company_details->branch_name; ?><br>
                                                                ...
                                                                <b>MICR : </b> <?php echo $company_details->mrcs; ?><br>
                                                                 -->
                                                                  <b> A/C NAME :</b> <?php echo $branch->account_name; ?><br>
                                                             <b>BRANCH :</b>  <?php echo $branch->bank_name; ?>,<?php echo $branch->acc_branch_name; ?><br>
                                                                <b>A/C NO : </b> <?php echo $branch->account_number; ?><br>
                                                                <b>IFSC : </b> <?php echo $branch->ifsc; ?><br>
                                                                <!-- <b>MICR : </b> <?php echo $company_details->mrcs; ?><br> -->
                                                               </td>
