                   ...
                   <div class="col-12  align-self-center">
                       ...
                       <div class="card">
                           <div class="card-header justify-content-between align-items-center">
                               <h4 class="card-title">Credit Note Invoice</h4>         
                                         ...
                                         //   echo '<pre>';print_r($allpoddata);die;
                                             foreach ($allpoddata as $value) {
                                               $cnt++;
                                                 ?>
                                                 <td><?php echo $cnt; ?></td>
                                                 <td><?php if($value['creadted_at']!=""){ echo date("d-m-Y",strtotime($value['creadted_at']) ); } ?></td>
                                                 ...
                                                 <td>
                                                    <a href="<?php base_url();?>admin/invoice-domestic-delete-credit-note/<?php echo $value['id']; ?>"  onclick="return  confirm('Are Sure You want to delete this Note!');"><i class="fa fa-trash" aria-hidden="true" style="color:red;"></i></a>
                                                 </td>
                                                 <?php } ?>
                                             </tr>
                                             <?php
     ...
     $(document).ready(function() {
       ...
       // alert(getid);
        var baseurl = '<?php echo base_url();?>'
            swal({
               title: 'Are you sure?',
               text: "You won't remove this Credit Note!",
               icon: 'warning',
