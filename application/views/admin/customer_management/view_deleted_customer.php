                              ...
                              <div class="table-responsive">
                                 ...
                                 <?php 
                                  ...
                                  <?php } ?>
                                    ...
                                    <td class="text-center">   <a href="javascript:void(0)" title="Delete" class = "deletedata1" relid ="<?php echo $cust['customer_id'];?>"><i class="ion-edit" style="color:var(--primarycolor)"></i></a></td>
                                      <td> 
