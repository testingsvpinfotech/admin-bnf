                 ...
                 <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Assign Stock Customer</h4>
<br>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <form  action="<?php echo base_url(); ?>admin/add-customer-stock-allowtment" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="col-3 mb-3">
                                                        ...
                                                        <select class="form-control" name="franchise" id="Franchise" required>
                                                            ...
                                                            <?php foreach($franchise1 as $val){ ?>
                                                                <option value = "<?= $val->customer_id; ?>"><?php  echo $val->customer_name.'--'.$val->cid; ?> </option>
                                                            <?php } ?>
...
// function getAvailable(obj){
    ...
    if (mode) {
        ...
        $.ajax({
            type: 'POST',
            url: 'Admin_customer_stock_allowtment/get_stock_value',
            data: 'mode=' + mode ,
            dataType: "json",
            success: function (d)
            {              
