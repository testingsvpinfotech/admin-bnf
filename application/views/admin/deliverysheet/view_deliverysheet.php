                    ...
                    <div class="col-12 col-sm-12 mt-3">
                        <div class="card">
                            <div class="card-header justify-content-between align-items-center">
                                ...
                                <span style="float: right;"><a href="admin/add-deliverysheet"
                                        class="fa fa-plus btn btn-primary">Add Deliverysheet</a></span>
                            </div>
                                            ...
                                            if (!empty($allpod)) {
                                                foreach ($allpod as $row) { ?>
                                                    <tr>
                                                        ...
                                                        <td><a
                                                                href="admin/print-deliverysheet/<?php echo $row['deliverysheet_id']; ?>">
                                                                <?php echo $row['deliverysheet_id']; ?>
                                                            </a></td>
                                                        <td>
                                                        ...
                                                        <td><a href="admin/deliverysheet-detail/<?php echo $row['deliverysheet_id']; ?>"
                                                                class="btn btn-flat btn-lg btn-labeled btn-primary"><i
                                                                    class="icon-info"></i></a></td>
                                                    </tr>
                                                <?php }
                                            }
                                            ?>
