				...
				<div class="col-12  align-self-center">
					<div class="col-12 col-sm-12 mt-3">
						<div class="card">
							...
							<br><br><h4 class="card-title">Other Branch Booking Domestic Shipment</h4>
									...
									<table id="example" class="display table dataTable table-striped table-bordered layout-primary" data-sorting="true">
										...
										<thead>
											<tr>
												...
												<th scope="col">Customer Branch Name</th>
										...
										<tbody>
											...
											?>
													...
													//	$whr_u = array('branch_id' => $value['branch_id']);
														...
														$branch_id_cust = $value['branch_name'];
														$branch_details1 = $this->db->query("select branch_name from  tbl_branch where branch_id ='$branch_id_cust' ")->row_array();
														?>
														<td><?php  echo substr($branch_details['branch_name'], 0, 20); ?></td>
														<td><?php  echo substr($branch_details1['branch_name'], 0, 20); ?></td>
														...
														<td><?php
															...
															$user_details = $this->db->query("select username from  tbl_users where user_id ='$user_id'")->row_array();
