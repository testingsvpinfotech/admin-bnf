				...
				<div class="col-12  align-self-center">
					<div class="col-12 col-sm-12 mt-3">
						<div class="card">
							...
							<div class="card-header justify-content-between align-items-center">
								<span>
									<form role="form" action="admin/view-domestic-shipment" method="get" enctype="multipart/form-data">
										<div class="form-row">
										...
										<tbody>
											...
											?>
													<tr class="odd gradeX" <?php if ($value['pickup_pending'] == 1) {
                                                        ...
                                                        <?php $pin = $value['reciever_pincode']; $dd = $this->db->query("select isODA from pincode where pin_code ='$pin'")->row_array();?>
														<!-- <td><?php // echo $value['forwording_no']; ?></td>
														<td><?php // echo $value['forworder_name']; ?></td> -->
														<td><?php echo $dd['isODA'];?></td>
													...
													//	$whr_u = array('branch_id' => $value['branch_id']);
														...
														$customer_id = $value['customer_id'];
														 ...
														 $getMasterfranchise = $this->db->query("select tbl_customers.customer_name from tbl_domestic_booking  join tbl_customers ON tbl_customers.parent_cust_id = tbl_domestic_booking.customer_id where parent_cust_id = '$customer_id' AND pod_no ='$pod' and customer_type ='1'")->result_array(); 
											...
											<?php
												...
												<!-- echo str_repeat("<td>", 12); -->
													<tr>
														<td colspan="25" class="text-center">NO RECORD FOUND</td>
													</tr>
											<?php  }
											?>
										</tbody>
