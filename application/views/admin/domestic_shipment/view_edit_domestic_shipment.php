								...
								<div class="card-body">
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											...
											<input type="datetime-local" name="booking_date" value="<?php echo date('Y-m-d\TH:i:s', strtotime($booking->booking_date . ' ' . $booking->booking_time)); ?>" id="booking_date" class="form-control" readonly>
										</div>
									</div>
									 <!-- <div class="form-group row">
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<select class="form-control mode_dispatch" name="mode_dispatch" id="mode_dispatch" required readonly disabled>
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input type="text" id="delivery_date" name="delivery_date" value="<?php echo $booking->delivery_date; ?>" readonly class="form-control">
											<input type="hidden" id="rate_new" name="rate" value="<?= $weight->rate;?>" class="form-control">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<select class="form-control" name="risk_type" id="risk_type" required readonly disabled>
											...
											<input type="hidden" name="risk_type"value="<?php echo $booking->risk_type;?>">
										</div>
										<label class="col-sm-4 col-form-label">Bill Type<span class="compulsory_fields">*</span></label>
										<div class="col-sm-8">
											<select class="form-control" name="dispatch_details" id="dispatch_details" readonly disabled >
								...
								<div class="card-body">
									<div class="form-group row">
										...
										<div class="col-sm-8" id="credit_div">
											<select class="form-control customer_show" name="customer_account_id" id="customer_account_id" readonly disabled  >
									...
									<div id="div_inv_row1" style="display: none;">
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<input type="text"  name="invoice_value" required id="invoice_value" value="<?php echo $booking->invoice_value; ?>" class="form-control my-colorpicker1">
											</div>
										</div>
									</div>
							...
							<div class="card-content">
								<div class="card-body">
									...
									<div class="form-group row">
										<label class="col-sm-4 col-form-label">Pincode<span class="compulsory_fields">*</span></label>
										<div class="col-sm-8">
											<input type="text" maxlength="6" minlength="6" class="form-control" name="reciever_pincode" id="reciever_pincode" value="<?php echo $booking->reciever_pincode; ?>" readonly disabled autocomplete="off">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<select class="form-control" id="reciever_state" name="reciever_state" readonly disabled>
												<option value="">Select State</option>
												<?php
												if (count($states)) {
													foreach ($states as $s) { ?>
											...
											<span class="compulsory_fields" id="isoda" style="color:red">Service Type : <?php echo service_type[$dd['isODA']];?></span><span class="compulsory_fields" id="noservice"></span>
										</div>
									</div>
									...
									<div class="form-group row">
										<label class="col-sm-4 col-form-label">City<span class="compulsory_fields">*</span></label>
										<div class="col-sm-8">
											<select class="form-control" id="reciever_city" name="reciever_city" readonly disabled>
												<option value="">Select City</option>
												<?php
												if (count($cities)) {
													foreach ($cities as $c) { ?>
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input type="text" name="receiver_zone" value="<?php echo $booking->receiver_zone; ?>" required id="receiver_zone" class="form-control" readonly disabled>
									...
									<div class="row">
										<div class="col-12">
											<div class="form-group row">
												...
												<div class="col-sm-4">
													<input type="text" name="no_of_pack" autocomplete="off" class="form-control my-colorpicker1 no_of_pack" value="<?php echo $weight->no_of_pack; ?>" data-attr="1" id="no_of_pack1" required="required">
												</div>
												<label class="col-sm-2 col-form-label">Actual Weight</label>
												<div class="col-sm-4">
													<input type="text" step="any" min = "0" name="actual_weight" autocomplete="off" class="form-control my-colorpicker1 actual_weight" value="<?php echo $weight->actual_weight; ?>" data-attr="1" id="actual_weight" required="required">
												</div>
												<label class="col-sm-2 col-form-label">Chargeable Weight</label>
												<div class="col-sm-4">
													<input type="text" step="any" min = "0" name="chargable_weight" value="<?php echo $weight->chargable_weight; ?>" class="form-control my-colorpicker1 chargable_weight" data-attr="1" id="chargable_weight" readonly required="required">
												...
												<div class="col-sm-1">
													...
													<input type="checkbox" id="is_volumetric" name="fav_language" checked <?php if($booking->doc_type=='1'){echo 'required'; } ?><?php echo (!empty($length_detail[0])) ? 'checked' : ''; ?>>
												...
												<table class="weight-table">
													<thead>
														...
														<tbody id="volumetric_table_row">
															...
															?>
																<tr>
																	<td><input type="number" name="per_box_weight_detail[]" autocomplete="off" class="form-control per_box_weight valid" min="1" data-attr="<?php echo ($jd + 1); ?>" id="per_box_weight<?php echo ($jd + 1); ?>" aria-invalid="false" value="<?php echo $per_box_weight_detail[$jd]; ?>"></td>
																	<td class="length_td"><input type="number" step="any" autocomplete="off" min = "0" name="length_detail[]" class="form-control length" data-attr="<?php echo ($jd + 1); ?>" id="length<?php echo ($jd + 1); ?>" value="<?php echo $length_detail[$jd]; ?>"></td>
																	<td class="breath_td"><input step="any" type="number" autocomplete="off" name="breath_detail[]" class="form-control breath" data-attr="<?php echo ($jd + 1); ?>" id="breath<?php echo ($jd + 1); ?>" value="<?php echo $breath_detail[$jd]; ?>"></td>
																	<td class="height_td"><input step="any" type="number" autocomplete="off" name="height_detail[]" class="form-control height" data-attr="<?php echo ($jd + 1); ?>" id="height<?php echo ($jd + 1); ?>" value="<?php echo $height_detail[$jd]; ?>"></td>

																	<td class="volumetic_weight_td"><input type="number" autocomplete="off" step="any" name="valumetric_weight_detail[]" readonly class="form-control valumetric_weight" data-attr="<?php echo ($jd + 1); ?>" id="valumetric_weight<?php echo ($jd + 1); ?>" value="<?php echo $valumetric_weight_detail[$jd]; ?>"></td>

																	<td class="volumetic_weight_td"><input step="any" autocomplete="off" type="number" name="valumetric_actual_detail[]" class="form-control valumetric_actual" data-attr="<?php echo ($jd + 1); ?>" id="valumetric_actual<?php echo ($jd + 1); ?>" value="<?php echo $weight_details['valumetric_actual_detail'][$jd]; ?>"></td>

																	<td class="volumetic_weight_td"><input type="number" autocomplete="off" step="any" name="valumetric_chageable_detail[]" readonly class="form-control valumetric_chageable" data-attr="<?php echo ($jd + 1); ?>" id="valumetric_chageable<?php echo ($jd + 1); ?>" value="<?php echo $weight_details['valumetric_chageable_detail'][$jd]; ?>"></td>
									...
									<div class="row">
										<div class="col-12">
											<div class="form-group row">
												...
												<div class="col-sm-3">
													<input type="number" step="any" name="frieht" class="form-control" value="<?php echo $booking->frieht; ?>" readonly required id="frieht" />
												</div>
												<label class="col-sm-3 col-form-label">Handling Charge</label>
												<div class="col-sm-3">
													<input type="number" step="any" name="transportation_charges" class="form-control" value="<?php echo $booking->transportation_charges; ?>" id="transportation_charges">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-sm-3 col-form-label">Pickup</label>
												<div class="col-sm-3">
													<input type="number" step="any" name="pickup_charges" value="<?php echo $booking->pickup_charges; ?>" class="form-control" id="pickup_charges">
												</div>
												<label class="col-sm-3 col-form-label">ODA Charge</label>
												<div class="col-sm-3">
													<input type="number" step="any" name="delivery_charges" value="<?php echo $booking->delivery_charges; ?>" class="form-control" value="0" id="delivery_charges">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-sm-3 col-form-label">Insurance</label>
												<div class="col-sm-3">
													<input type="number" step="any" name="insurance_charges" class="form-control" value="<?php echo $booking->insurance_charges; ?>" id="insurance_charges">
												</div>
												<label class="col-sm-3 col-form-label">COD</label>
												<div class="col-sm-3">
													<input type="number" step="any" name="courier_charges" class="form-control" value="<?php echo $booking->courier_charges; ?>" id="courier_charges">
												</div>
											...
											<div class="form-group row">
												...
												<div class="col-sm-3">
													<input type="number" step="any" name="awb_charges" class="form-control" value="<?php echo $booking->awb_charges; ?>" id="awb_charges">
												</div>
												<label class="col-sm-3 col-form-label">Other Ch.</label>
												<div class="col-sm-3">
													<input type="number" step="any" name="other_charges" class="form-control" value="<?php echo $booking->other_charges; ?>" id="other_charges">
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-sm-3">
													<input type="number" step="any" name="green_tax" class="form-control" value="<?php echo $booking->green_tax; ?>" id="green_tax">
												</div>
												<label class="col-sm-3 col-form-label">Appt Ch.</label>
												<div class="col-sm-3">
													<input type="number" step="any" name="appt_charges" class="form-control" value="<?php echo $booking->appt_charges; ?>" id="appt_charges">
												</div>
											</div>
											<div class="form-group row">
												...
												<div class="col-sm-3">
													<input type="number" step="any" readonly="readonly" class="form-control" name="fov_charges" id="fov_charges" value="<?php echo $booking->fov_charges; ?>">
												</div>
												<label class="col-sm-3 col-form-label">Total</label>
												<div class="col-sm-3">
													<input type="number" step="any" readonly name="amount" class="form-control" value="<?php echo $booking->total_amount; ?>" id="amount" />
												</div>
											...
											<div class="form-group row">
												...
												<div class="col-sm-3">
													<input type="number" step="any" readonly="readonly" class="form-control" name="fuel_subcharges" value="<?php echo $booking->fuel_subcharges; ?>" id="fuel_charges">
												</div>
												<label  class="col-sm-3 col-form-label">Address Change</label>
												<div class="col-sm-3">
													<input type="number" step="any" class="form-control" name="address_change" value="<?php echo $booking->address_change; ?>" id="address_change">
												</div>
											</div>
											<div class="form-group row">
												<label  class="col-sm-3 col-form-label">DPH	</label>
												<div class="col-sm-3">
													<input type="number" step="any" class="form-control" name="dph" value="<?php echo $booking->dph; ?>" id="dph">
												</div>
												<label  class="col-sm-3 col-form-label">Warehousing Change</label>
												<div class="col-sm-3">
													<input type="number" step="any" class="form-control" name="warehousing" value="<?php echo $booking->warehousing; ?>" id="warehousing">
												</div>
											</div>
											<div class="form-group row">
												<?php
												...
												<div class="col-sm-3">
													<input type="text"  class="form-control txtOnly" name="adhoc_lable[]" pattern="[a-zA-Z]+" value="<?php echo (isset($adhoc_lable[0]))?$adhoc_lable[0]:''; ?>"  id="lable">
												</div>
											...
											<div class="form-group row">
												<label  class="col-sm-3 col-form-label">Lable	</label>
												<div class="col-sm-3">
													<input type="text"  class="form-control txtOnly" name="adhoc_lable[]" pattern="[a-zA-Z]+" value="<?php echo (isset($adhoc_lable[1]))?$adhoc_lable[1]:''; ?>"  id="lable">
												</div>
												<label  class="col-sm-3 col-form-label">Charges</label>
												<div class="col-sm-3">
											...
											<div class="form-group row">
												<label  class="col-sm-3 col-form-label">Lable	</label>
												<div class="col-sm-3">
													<input type="text"  class="form-control txtOnly" name="adhoc_lable[]" pattern="[a-zA-Z]+" value="<?php echo (isset($adhoc_lable[2]))?$adhoc_lable[2]:''; ?>"  id="lable">
												</div>
												<label  class="col-sm-3 col-form-label">Charges</label>
												<div class="col-sm-3">
										...
										<div class="col-12">
											...
											<div class="form-group row mt-3">
												<div class="col-sm-12">
													...
													<!-- <button type="button" class="btn btn-primary" onclick="return NotifySubmission();">Submit</button> &nbsp; -->
