                  ...
                  <div class="col-12  align-self-center">
                      ...
                      <div class="card">
                          <div class="card-header justify-content-between align-items-center">
                              <h4 class="card-title">Add Franchise Incoming</h4>  
                          </div>
                          <div class="card-body">
                              
						   <div class="row">                                           
                            <div class="col-12">
								 <form role="form" action="admin/add-franchise-incoming" method="post">
        <div class="box-body">
			...
			<form role="form" action="admin/add-franchise-incoming" method="post">
				...
				<?php 
											...
											// $datec = str_replace(' ', 'T', $datec);
										?>
								  <input type="datetime-local" class="form-control" name="datetime" id="exampleInputEmail1" required value="<?= $datec; ?>">
								</div>
							</div>
					<thead>
					<tr>
					...
					<tbody>
					 ...
					 $recived = 0;
					  ...
					  ?>
					<tr>
					  <td><input type="checkbox" name="bag_no[]" <?php echo ($value->reciving_status > 0)?'disabled':'';?> checked value="<?=$value->bag_no?>"></td>
					  <td><?=$value->bag_no?></td>
					  <td><?=$value->destination_branch?></td>
					  <td><?=$value->total_pcs?></td>
					  <td><?=$value->total_weight?></td>
					  <td><textarea name="recived_nop" <?php echo ($value->reciving_status > 0)?'disabled':'';?> placeholder="Recived NOP"></textarea></td>
					  <td><textarea name="balance_nop" <?php echo ($value->reciving_status > 0)?'disabled':'';?> placeholder="Balance NOP"></textarea></td>
					  <?php 
					  ...
					  <?php 
						...
						else
						{
							...
							<td>Recieved</td>
	<?php 				} ?> 
	                   <td><textarea name="note[]" <?php echo ($value->reciving_status > 0)?'disabled':'';?> placeholder="remark"></textarea></td>
