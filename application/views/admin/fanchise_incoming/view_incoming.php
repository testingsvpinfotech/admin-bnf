                    ...
                    <div class="col-12 col-sm-12 mt-3">
                        <div class="card">
                            <div class="card-header justify-content-between align-items-center">
                                <h4 class="card-title">View Franchise Incoming</h4>
                                <span style="float: right;"><a href="admin/add-franchise-incoming"
                                        class="fa fa-plus btn btn-primary">Add Franchise Incoming</a></span>
                            </div>
                            <br>
