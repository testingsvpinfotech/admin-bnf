        ...
        <main>
                  ...
                  <div class="col-12  align-self-center">
                      ...
                      <div class="card">
                          <div class="card-header justify-content-between align-items-center">                               
                              <h4 class="card-title">Add Fuel Group Master</h4>
         ...
         <!--Add Vehicle Type</a></span>-->
                          ...
                          <?php if ($this->session->flashdata('notify') != '') { ?>
                               ...
                               <div class="col-12">
                                            <form role="form" action="<?php echo base_url();?>admin/fule-group-master" method="post" enctype="multipart/form-data">
