                    ...
                    <div class="col-12 col-sm-12 mt-3">
                        <div class="card">
                            <div class="card-header justify-content-between align-items-center">
                                ...
                                <span style="float: right;"><a href="admin/add-incoming"
                                        class="fa fa-plus btn btn-primary">Add Incoming</a></span>
                            </div>
                                            ...
                                            if (!empty($allinword)) {
                                                ...
                                                foreach ($allinword as $value) {
                                                    ...
                                                    if ($total == 0) {
                                                        ...
                                                        <td>
                                                            <?php if (empty($value['gatepass_no'])) {
                                                                echo 'NA';
                                                            } else {
                                                                echo $value['gatepass_no'];
                                                            } ?>
                                                        </td>
                                                        <td><a
                                                                href="<?= base_url('admin/tracking-domestic-menifiest/' . $value['manifiest_id']); ?>">
                                                                <?php echo $value['manifiest_id']; ?>
                                                            </a></td>
                                                        <td>
                                                        ...
                                                        <td><a href="admin/add-incoming/<?php echo $value['manifiest_id']; ?>"><i
                                                                    class="ion-edit" style="color:var(--primarycolor)"></i></a></td>
                                                        </tr>
                                                        <?php
                                                        $cnt++;
                                                    }
