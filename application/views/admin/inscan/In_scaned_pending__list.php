                    ...
                    <div class="col-12 col-sm-12 mt-3">
                        <div class="card">
                            <div class="card-header justify-content-between align-items-center">
                                <h4 class="card-title">IN-Scaned Pending list</h4>
                            </div>
                            <div class="card-body">
                                <div class="col-md-12">
                                    <table id="example" class="display table dataTable table-striped table-bordered" >
                                        ...
                                        <tbody>
                                            ...
                                            <?php if (!empty($In_Scan_pending_List)) { ?>
                                                <?php $i = 1; foreach ($In_Scan_pending_List as $value) : ?>
                                                    <tr>
                                                        <td><?php echo $i++;?></td>
                                                        ...
                                                        <td><?php $val = $value['mode_dispatch'];
                                                              $mode = $this->db->query("select * from transfer_mode where transfer_mode_id = '$val'")->row();
                                                              echo $mode->mode_name;
                                                         ?></td>
