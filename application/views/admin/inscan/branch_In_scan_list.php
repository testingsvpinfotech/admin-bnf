                    ...
                    <div class="col-12 col-sm-12 mt-3">
                        <div class="card">
                            <div class="card-header justify-content-between align-items-center">
                                <h4 class="card-title">Branch IN-Scan list</h4>
                            </div>
                            <div class="card-body">
                                <div class="col-md-12">
                                    <table id="example" class="display table dataTable table-striped table-bordered" >
                                        ...
                                        <tbody>
                                            ...
                                            <?php if (!empty($branch_In_Scan_List)) { ?>
                                                <?php $i = 1; foreach ($branch_In_Scan_List as $value) : ?>
                                                    <tr>
                                                        <td><?php echo $i++;?></td>
                                                        ...
                                                        <td><?php echo $value['branch_inscan_comment']; ?></td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            <?php } else { ?>
                                                <tr>
