                    ...
                    <div class="col-12 col-sm-12 mt-3">
                        <div class="card">
                            <div class="card-header justify-content-between align-items-center">
                                <h4 class="card-title">Branch-In-Scan</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                        ...
                                        <br>
                                        <!--  col-sm-4-->
                                        <form action="<?= base_url('admin/branch-in-scan'); ?>" method="post">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <label>Comment</label>
                                        <textarea name="branch_inscan_comment" class="form-control" id="branch_inscan_comment"></textarea>
                                    </div>
    ...
    $(document).ready(function() {
        $("#btn_search").click(function() {
            ...
            if (forwording_no != "") {
                ...
                $.ajax({
                    url: "Admin_Inscan/branch_awb_scan",
                    type: 'POST',
                    dataType: "html",
                    data: {
