                    ...
                    <div class="col-12 col-sm-12 mt-3">
                        <div class="card">
                            <div class="card-header justify-content-between align-items-center">
                                <h4 class="card-title">Direct Franchise Shipments In Scan In Branch</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                        ...
                                        <input type="text" id="search_data" name="awb_no" placeholder="Enter Pod No" required style="float: right;">
                                        <input type="button" id="btn_search" style="float: right;" value="Search">
                                        <form action="<?= base_url('admin/direct-fr-scan'); ?>" method="post">
                                        <br>
                                        <!--  col-sm-4-->
            ...
            if (forwording_no != "") {
                ...
                $("input[name='pod_no[]']").map(function() {
                    ...
                    if (number[0] == forwording_no) {
                        message = 'This POD No Already Exist In The List!';
                        // return false;
                    }
                }).get();
                ...
                $.ajax({
                    url: "Admin_Inscan/fr_direct_scan",
                    type: 'POST',
                    dataType: "html",
                    data: {
            ...
            if (e.keyCode == 13) {
                ...
                if (forwording_no != "") {
                    ...
                    $("input[name='pod_no[]']").map(function () {
                        ...
                        if (number[0] == forwording_no) {
                            message = forwording_no+' This LR No Already Exist In The List!';
                            // return false;
                        }
                    }).get();
                   ...
                   //swal('Please enter Forwording no');
                }
