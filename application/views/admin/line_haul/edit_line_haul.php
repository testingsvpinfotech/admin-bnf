             ...
             <div class="col-12 mt-3">
                    <div class="card">
                        <div class="card-header">                               
                            <h4 class="card-title">Edit Line Haul</h4>                                
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                            <div class="row">                                           
                                <div class="col-12">
                                <form role="form" action="<?php echo base_url();?>admin/edit-line-haul/<?php echo $rgn->route_id; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                 <div class="table-responsive">
                      <table class="table layout-primary table-bordered">
                          ...
                          <tbody>
                            <?php 
                            $rgn_detail  =$this->basic_operation_m->get_query_result('select * from tbl_line_hual_master_details left join city on city.id=tbl_line_hual_master_details.city where routeid='.$rgn->route_id.' ');
                            ?>
                            <tr>
