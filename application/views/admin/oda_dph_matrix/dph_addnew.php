<?php include dirname(__FILE__) . '/../admin_shared/admin_header.php';?>
  ...
  <?php unset($_SESSION['class']);unset($_SESSION['notify']);}?>
						<div class="row">
							<div class="col-12">
                <?php 
                  $url = !empty($dph_data)?'admin_oda_dph_matrix/insert_dph_master/'.$dph_data->id:'admin_oda_dph_matrix/insert_dph_master';
                ?>
                <form role="form" action="<?php echo base_url().$url; ?>" method="post" enctype="multipart/form-data">
                   ...
                   <label class="col-sm-1 col-form-label">Date</label>
                    ...
                    <div class="col-sm-2">
                      <input class="form-control" name="rate_perkg" id="rate_perkg" value="<?= !empty($dph_data)?$dph_data->ltr_rate_perkg:''; ?>" required>
                    </div>
									</div>
									  <div class="col-md-2">
                      <br><br>
