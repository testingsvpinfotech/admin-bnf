                  ...
                  <div class="col-12  align-self-center">
                      ...
                      <div class="card">
                          <div class="card-header justify-content-between align-items-center">
                              ...
                              <a href="<?= base_url(); ?>Admin_oda_dph_matrix/addnew_dph_matrix" class="btn btn-primary btn-sm">ADD NEW</a>
                                        ...
                                        if (!empty($dph_data)) {
                                            foreach ($dph_data as $value) {
                                              ...
                                              <tr>
                                                ...
                                                <td><?php echo $value->ltr_rate_perkg; ?></td>
                                                <td>
                                                  <a title="Edit" href="<?php base_url();?>Admin_oda_dph_matrix/update_dph_matrix/<?= $value->id; ?>" class="btn btn-primary"><i class="icon-pencil"></i></a>
                                                </td>
                                              </tr>
                                              <?php $cnt++;
                                            }
