								...
								<div class="card-body">
									<div class="row">
										...
										<div class="col-sm-12">
											...
											<div class="form-group">
												<input  name="pickup_pincode" type="number" min="6" class="form-control"required>
											</div>
										</div>
										<div class="col-sm-12">
										...
										<div class="col-sm-12">
											...
											<div class="form-group">
												<input type="text"  name="consigner_contact" class="form-control check_phone_number" required>
											</div>
										</div>
										<div class="col-sm-12">
											<label>Destination Address<span class="compulsory_fields">*</span></label>
											<div class="form-group">
												<input type="text" name="consigner_address1" class="form-control"required>
											</div>
										</div>
										<div class="col-sm-12">
											<label>Destination City<span class="compulsory_fields">*</span></label>
											<div class="form-group">
								...
								<div class="card-body">
									<div class="row">
										<div class="col-sm-3">
											...
											<div class="form-group">
												<input type="text" name="destination_pincode[]" type="number" min="6" placeholder="Enter Pincode" class="form-control"required>
											</div>
										</div>
										<div class="col-sm-2">
	...
	<script>
		$(document).ready(function() {
			var d = "<div class='row' id='remove_row'><div class='col-sm-3'>" +
				"<label>Drop Location<span class='compulsory_fields'>*</span></label>" +
				"<div class='form-group'>" +
				"<input type='text' name='destination_pincode[]' placeholder='Enter Pincode' class='form-control'>" +
				"</div>" +
				"</div>" +
				"<div class='col-sm-2'>" +
				"<label>Weight<span class='compulsory_fields'>*</span></label>" +
