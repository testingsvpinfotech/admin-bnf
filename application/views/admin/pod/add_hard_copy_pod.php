               ...
               <div class="col-12 col-sm-12 mt-3">
                 <div class="card">
                   <div class="card-header justify-content-between align-items-center">
                     <h4 class="card-title">Update Hard Copy Pod</h4>
                   ...
                   <div class="card-body">
                     ...
                     <div class="row">
                       <div class="col-12">
                         <form role="form" action="admin/hard-copy-pod-edit" method="post" enctype="multipart/form-data">
                           <div class="box-body">
                             <div class="form-group row">
                                   ...
                                   <?php
                                    if (count($deliverysheet)) {
                                      foreach ($deliverysheet as $rows) {
                                        ...
                                        if ($total >= 0) {
                                    ?>
                                         <option value="<?php echo $rows['pod_no']; ?>"><?php echo $rows['pod_no']; ?></option>
                                   <?php
                                        }
                                      }
                                    } else {
                               ...
                               <label class="col-sm-2 col-form-label">Hard Copy Date & Time:</label>
                               <div class="col-sm-2">
                                 <input type="datetime-local" class="form-control" id="booking_date" value="<?php echo date('Y-m-d H:i:s'); ?>" name="booking_date" >
                               </div>
                               <label class="col-sm-2 col-form-label">Hard Copy Recived By :</label>
                               <div class="col-sm-2">
                                 <input type="text" class="form-control" id="jq-validation-email" name="hc_recived_by" value="<?= $_SESSION['userName']; ?>" readonly>
                               </div>
