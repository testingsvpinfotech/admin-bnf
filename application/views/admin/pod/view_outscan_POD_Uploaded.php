               ...
               <div class="col-12 col-sm-12 mt-3">
                 <div class="card">
                   <div class="card-header justify-content-between align-items-center">
                     <h4 class="card-title">Outscan POD Uploaded</h4>
                            ...
                            ?>
                               <tr class="odd">
                                  ...
                                  <?php 
                                   ...
                                   $whr = array('branch_id'=>$res2->row()->branch_id);
                                  ...
                                  <td><?php echo $res1->row()->sender_name; ?></td>
                                  <td><?php echo $res1->row()->reciever_name; ?></td>
                                  <td><?php echo $res1->row()->delivery_date; ?></td>
                                  <td><?php echo $res3->row()->branch_name; ?></td>
