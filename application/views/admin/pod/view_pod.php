                            ...
                            ?>
                               <tr class="odd">
                                 <td><?php echo $cnt; ?></td>
                                  ...
                                  if($ext[1] =='pdf'){?>
                                  <a href="<?= base_url('assets/pod/'.$row->image);?>" target="_blank"><i class="fa fa-link" aria-hidden="true"> View Pod</i></a>
                                <?php }else{?>
                                ...
                                <?php } ?>
                                  ...
                                  <?php if ($this->session->userdata("userType") == 1) { ?>
                                  <td><a href="javascript:void(0)" onclick="getPod123(<?php echo $row->id; ?>)"><i class="ion-trash-b" style="color:var(--danger)"></i></a></td>
                                  <?php } ?>                                 
                               </tr>
                           <?php
                                $cnt++;
