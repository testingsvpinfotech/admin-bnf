                  ...
                  <div class="col-12  align-self-center">
                      ...
                      <div class="card">
                          ...
                          <div class="card-content">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                    <form role="form" action="<?php echo base_url(); ?>admin/list-mis-report" method="get" enctype="multipart/form-data">
                                        <div class="form-row">
                                             <div class="form-row">
                                                    <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <a href="<?= base_url('admin/list-mis-report'); ?>" class="btn btn-primary" style="margin-top: 25px;">Reset</a>
                                                </div>
                                            </div>
