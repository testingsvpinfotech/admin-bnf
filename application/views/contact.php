        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 sm-mb-45px">
                    ...
                    <h5>Phone :</h5>
                    <a href="tel:+91 9819598197"><span class="d-block"><i class="fa fa-phone text-main-color margin-right-10px" aria-hidden="true"></i>+91-9819598197</span></a>
                    <h5 class="margin-top-20px">Corporate Office :</h5>
                    <span class="d-block sm-mb-30px"><i class="fa fa-map text-main-color margin-right-10px" aria-hidden="true"></i> Unit No 133/134 1st floor, Udyog Bhavan Premises Co-Operative Society Limited, Sonawala Road, Goregaon (East), Mumbai 400 063</span>
