                                 ...
                                 <table class="display table dataTable table-striped table-bordered layout-primary" data-sorting="true"><!-- id="example"-->
                                      <thead>
                                          <tr>
												...
												<th  scope="col">Track Shipment</th>
                                 ...
                                 <?php 
                                    if (!empty($allpoddata))
									{
										...
										foreach ($allpoddata as $value) 
										{
                                            ...
                                            $status_details = $this->db->query("select * from tbl_domestic_tracking where booking_id = '".$value['booking_id']."' order by id desc limit 1")->row_array();
                                    ...
                                    ?>
											<tr class="odd gradeX">
												...
												<td>													
												<?php echo '<a href="'.base_url().'users/track_shipment?pod_no='.$value['pod_no'].'&submit=1" target="_blank" title="Track" class="ring-point btn btn-primary" >Track</a>';
