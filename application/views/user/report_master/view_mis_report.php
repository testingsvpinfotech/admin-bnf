                                                     ...
                                                     <div class="row">
                                                         ...
                                                         <div class="col-sm-2">
                                                             ...
                                                             <select class="form-control" name="company_type">
                                                                 <option value="ALL" <?php if ($company_type == "ALL") {
                                                                                            echo "selected";
                                                                                        } ?>>ALL</option>
                                                                 <option value="International" <?php if ($company_type == "International") {
                                                                                                    echo "selected";
                                                                                                } ?>>International</option>
                                                                 <option value="Domestic" <?php if ($company_type == "Domestic") {
                                                                                                echo "selected";
                                                                                            } ?>>Domestic</option>
                                                             </select>
                                                         </div>
                                                         ...
                                                         <div style="display: contents;">
                                                             <div class="col-md-2">
                                                                 ...
                                                                 <a href="<?php echo base_url(); ?>User_panel/report" class="btn btn-danger">Reset</a>
                                                             </div>
                                                             <!-- <div class="col-md-2">
                                                                 <label></label><br><br>
                                                                 <a href="<?php echo base_url(); ?>User_panel/report" class="btn btn-danger">Reset</a>
                                            ...
                                            ?>
                                                 <tr>
                                                    ...
                                                    <td><?php echo $value_d['sender_name']; ?></td>
                                                     ...
                                                     <td><?php echo $value_d['actual_weight']; ?></td>
