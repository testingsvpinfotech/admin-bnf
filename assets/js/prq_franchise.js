...
// 			$.ajax({
// 				type: 'POST',
// 				url: 'Franchise_manager/add_new_rate_domestic',
...
// 		});
 ...
 //                type: 'POST',
 //                dataType: "json",
 //                url: 'Franchise_manager/check_duplicate_awb_no',
 //                data: 'pod_no=' + pod_no,
 //                success: function (data) {
 //                    if(data.msg!=""){       
 //                    		 $('#awn').focus();
...
// *****************************************************page Js**************************##############################
	...
	$("#customer_account_id").change(function () 
	{
		...
		if (customer_name != null || customer_name != '') 
		{
			$.ajax({
				type: 'POST',
				dataType: "json",
				url: 'Franchise_manager/getsenderdetails',
	...
	// 					return false;
	// 				}else{
	// 					$('#reciever_city').val(data.id);
	// 					$('#reciever_state').val(data.state_id);	
	// 					$("#receiver_zone_id").val(data.regionid);
	// 					$("#receiver_zone").val(data.regionid);	
	// 				}		
	// 			}
	// 		});
	...
	$("#sender_pincode").on('blur', function() {
		...
		if (pincode != null || pincode != '') {
			...
			$.ajax({
				...
				success: function(data) {
					var option1;
					option1 += '<option value="' + data.result3.id + '">' + data.result3.state + '</option>';
					$('#sender_state').html(option1);
